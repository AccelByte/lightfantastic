...
{
    public partial struct GgpEntitlement
    {
        ...
        public GgpItemType item_type;
        
        internal unsafe struct entitlement_transaction_id_fixed
        {
            private unsafe fixed byte entitlement_transaction_id_val[totalsize];
            private const int totalsize = 40;
            ...
            public unsafe byte[] Data
            {
                ...
                set
                {
                    ...
                    for (int i = 0; i < passedSize; ++i)
                    {
                        entitlement_transaction_id_val[i] = value[i];
                    }
                }
            }
            ...
            public unsafe string DataAsString
            {
                get
                {
                    ...
                    for (int i = 0; i < totalsize; ++i)
                    {
                        if (entitlement_transaction_id_val[i] == 0)
                            break;

                        list.Add(entitlement_transaction_id_val[i]);
                    }
                ...
                set
                {
                    ...
                    for (int i = 0; i < passedSize; ++i)
                    {
                        entitlement_transaction_id_val[i] = bytes[i];
                    }

                    entitlement_transaction_id_val[bytes.Length] = 0;
                }
            }
            ...
            public unsafe void GetDataToExistingBuffer(ref byte[] data)
            {
                ...
                for (int i = 0; i < totalsize; ++i)
                {
                    data[i] = entitlement_transaction_id_val[i];
                }
            }
        }

        
        private entitlement_transaction_id_fixed entitlement_transaction_id_data;

        public byte[] entitlement_transaction_id
        {
            get { return entitlement_transaction_id_data.Data; }
            set { entitlement_transaction_id_data.Data = value; }
        }

        public string entitlement_transaction_idAsString
        {
            get { return entitlement_transaction_id_data.DataAsString; }
            set { entitlement_transaction_id_data.DataAsString = value; }
        }

        public void entitlement_transaction_idToExistingBuffer(ref byte[] data)
        {
            entitlement_transaction_id_data.GetDataToExistingBuffer(ref data);
        }
